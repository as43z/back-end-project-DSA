...
public class ItemService {
    ...
    public ItemService(){
        ...
        {
            //Adding Items
            this.manager.registerItem("item_01", "item_01", "item_01");
            this.manager.registerItem("item_02", "item_02", "item_02");
            this.manager.registerItem("item_03", "item_03", "item_03");
            this.manager.registerItem("item_04", "item_04", "item_04");
        }
    }
